...
| tachyonfx | 0.25.0 | 2 | Helm motion-policy effects registry for bounded gate/verdict/node-state effects on ratatui 0.29. | Hand-coded effect frames would duplicate timing/preemption policy and make reduced/off motion harder to audit. | helm-p14 |
