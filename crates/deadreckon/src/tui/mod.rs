...
pub(crate) use render::{
    ...
    process_lines, provider_is_metered, render_attach, render_campaign_attach, render_chain_attach,
    render_plan_attach, run_narrative_projection, run_narrative_projection_signature,
};
...
pub(crate) use render::{
    ...
    plan_attach_footer, render_campaign_attach_text, scroll_indicator, selection_glyph,
    threshold_color,
};
