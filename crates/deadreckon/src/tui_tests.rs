...
use super::{
    ...
    AttachLive, AttachLoopStage, AttachNarrativeProjectionCache, AttachNarrativeRefreshState,
    ...
    AttachViewMode, AttachWorkMode, COMMAND_HELP_CATALOG, CommandAudience, CommandDiscovery,
    CommandHelpEntry, CompletionAction, ConfigDefaults, GoalShape, GoalShapeRecommendation,
    GoalShapeSource, HELP_ALL_GROUPS, LiveFile, NOUN_DONE_CONTRACT, NOUN_VERIFIED_RUN,
    ...
    PlanAttachRenderState, PlanDocRefreshOptions, PlanFeedEvent, PlanNarrativeRefreshInput,
    PlanProviderAsBuilt, PlanProviderChild, PlanProviderDecisions, PlanProviderDocs,
    PlanProviderItem, PlanProviderNarrative, PlanWrapperDocContext, ProviderActivity,
    ...
    markdown_to_tui_lines, materialize_plan_docs_to_working, maybe_prompt_start_mode, meter_color,
    narrative_provider_selection, parse_provider_goal_shape, plan_attach_footer, plan_doc_path,
