...
use deadreckon_core::{
    ...
    SOURCE_HYDRATION_MANIFEST_JSON, WorktreeOptions, acceptance_progress_path_for_run_root,
    ...
    copy_artifact_path, copy_deliverable_tree, copy_source_to_working_with_policy, copy_tree,
    create_run, create_worktree, doc_path_for_kind, docs_status_for_state, emit_event,
    evaluate_acceptance_checks, freeze_workspace_capture_policy, inventory_files, list_runs,
    ...
    release_lock_file, remove_artifact_path, resolve_mode, restore_snapshot, run_status_label,
    save_chain, save_state, terminate_pid, validate_acceptance_marker, validate_task_count,
    write_acceptance_marker, write_cancel_marker, write_capture_manifest, write_chain_step_marker,
    write_child_summary, write_plan_child_marker, write_worker_spec,
